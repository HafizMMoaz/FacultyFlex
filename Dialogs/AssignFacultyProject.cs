...
namespace DBS25P023.Dialogs {
    public partial class AssignFacultyProject : Form {
        ...
        public AssignFacultyProject(string Action) {
            InitializeComponent();
            this.Action = Action;
            PopulateData();
        }

        public AssignFacultyProject(Faculty faculty, string Action) {
            InitializeComponent();
            this.Action = Action;
            PopulateData();
        ...
        public AssignFacultyProject(FacultyProject project, string Action) {
            InitializeComponent();
            this.Action = Action;
            PopulateData();
        ...
        private void ActionBtn_Click(object sender, EventArgs e) {
            ...
            if (!int.TryParse(SuperVisionHours.Text, out _)) {
